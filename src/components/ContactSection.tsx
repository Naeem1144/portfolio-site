              ...
              <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
                <div className="space-y-6 flex-1">
                  <div className="group">
                    ...
                    >
                      Full Name <span className="text-red-500/80 dark:text-red-400/80 ml-1" aria-hidden="true">*</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <div className="group">
                    ...
                    >
                      Email Address <span className="text-red-500/80 dark:text-red-400/80 ml-1" aria-hidden="true">*</span>
                    </label>
                    <input
                      type="email"
                      id="email"
                  ...
                  <div className="group flex-1">
                    ...
                    >
                      Message <span className="text-red-500/80 dark:text-red-400/80 ml-1" aria-hidden="true">*</span>
                    </label>
                    <textarea
                      id="message"
                      name="message"
